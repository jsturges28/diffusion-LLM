...
- **Timing chart:** cumulative elapsed time per frame (accumulates across resumes). Remask transitions are highlighted in green. The processor that produced the run is listed in the run summary above the charts.
